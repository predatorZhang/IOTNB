...
var App = function () {
    ...
    var handleSidebarMenu = function () {
        ...
        jQuery('.page-sidebar').on('click', 'li > a', function (e) {
            if ($(this).next().hasClass('level-2') == false) {
                $(".level-1 li").removeClass('selected');
                $(".level-2 li").removeClass('selected');
                jQuery(this).parent().addClass("selected");
                if(jQuery(this).parent().parent().hasClass("level-2")){
                    jQuery(this).parent().parent().parent().addClass("selected");
                }else{
                    //点击的为一级标题
                    jQuery(this).parent().parent().children('li.selected').children('.level-2').slideUp(200);
            ...
            parent.children('li.selected').children('a').children('.arrow').removeClass('selected');
            parent.children('li.selected').children('.level-2').slideUp(200);
            parent.children('li.selected').removeClass('selected');
            $(".level-2 li").removeClass('selected');


            var sub = jQuery(this).next();
            if (sub.is(":visible")) {
                jQuery('.arrow', jQuery(this)).removeClass("selected");
                ...
                jQuery('.arrow', jQuery(this)).addClass("selected");
